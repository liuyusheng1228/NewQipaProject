...
import com.qipa.jetpackmvvm.pay.alipay.Base64.decode
import com.qipa.jetpackmvvm.pay.alipay.Base64.encode
...
object SignUtils {
    ...
    fun sign(content: String, privateKey: String?, rsa2: Boolean): String? {
        try {
            ...
            val keyf: KeyFactory = KeyFactory.getInstance(ALGORITHM)
