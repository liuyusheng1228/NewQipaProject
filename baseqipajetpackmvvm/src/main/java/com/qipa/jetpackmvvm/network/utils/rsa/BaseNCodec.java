...
import com.qipa.jetpackmvvm.network.utils.rsa.commons.BinaryDecoder;
import com.qipa.jetpackmvvm.network.utils.rsa.commons.BinaryEncoder;
...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    public Object decode(Object obj) {
        if (obj instanceof byte[]) {
            ...
            throw new DecoderException("Parameter supplied to Base-N decode is not a byte[] or a String",null);
        }
    }
