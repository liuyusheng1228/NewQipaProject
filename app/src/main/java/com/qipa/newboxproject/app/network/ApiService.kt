...
interface ApiService {
    ...
    companion object {
        ...
        const val SERVER_URL_CESHI = "http://192.168.0.44:8088"
     ...
     */
    @FormUrlEncoded
    @POST("/dev-api/third/app-user/bindPhone")
     ...
     */
    @FormUrlEncoded
    @POST("/dev-api/third/app-user/unBindPhone")
     ...
     */
    @Multipart
    @POST("/dev-api/system/oss/upload")
    suspend fun upload(
        @Part file: MultipartBody.Part
    ): ApiResponse<UploadPicUserBean>

    /**
     * 更新用户信息
     */
    @FormUrlEncoded
    @POST("/dev-api/third/app-user/updateUserInfo")
     ...
     * 获取用户信息
     */
    @GET("/dev-api/third/app-user/getUserInfo")
     ...
     */
    @FormUrlEncoded
    @POST("/dev-api/third/app-user/userRealName")
    suspend fun userRealName(
        @Field("params") params: String
    ): ApiResponse<String>
    ...
    ): ApiResponse<WxUserInfoResponse>
